...
A hobbie project that analyzes http://www.localbitcoins.com to get currency rates and calculate intermediate rates and render history graphs. Mostly oriented to Venezuelans, but anyone can choose currencies. +
